  ...
  return (
    <section className="relative bg-white">
      <div className="container py-20 lg:py-24">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-ink-900 via-ink-800 to-ink-900 p-10 lg:p-14">
          <div className="absolute -top-32 -right-20 h-[440px] w-[640px] bg-soft-radial blur-2xl opacity-90 pointer-events-none" />
          ...
          <div className="relative grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="mt-4 text-[15.5px] text-ink-300 max-w-2xl leading-relaxed">
            ...
            <div className="lg:col-span-4 flex flex-col gap-3">
              <Link
                href="/cotizar"
                className="inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-md bg-brand text-white font-semibold hover:bg-brand-600 transition shadow-glow"
              >
